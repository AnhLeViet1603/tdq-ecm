...
# ─────────────────────────────────────────────────────────────
# Entrypoint: order service (port 8005)
# ─────────────────────────────────────────────────────────────
...
echo "[$(date -u +%H:%M:%S)] Creating migrations for app 'order'..."
python manage.py makemigrations order --noinput || true
...
echo "[$(date -u +%H:%M:%S)] Starting order on port ${SERVICE_PORT:-8005}..."
